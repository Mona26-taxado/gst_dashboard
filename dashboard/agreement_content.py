...
Bump AGREEMENT_VERSION when legal text or meaning changes (platform / GSK users).
WL tenant users use WL_AGREEMENT_VERSION separately.
"""
...
def _built_in_wl_default_terms():
    """White Label network (Zingo Buy / Zingofin) — separate from platform GSK agreement."""
    return """
Service-Level-Agreement
Customer Name: {{NAME}}
Address: {{ADDRESS}}
...
ZINGO BUY INDIA PRIVATE LIMITED
Registered Office at 2/8 Nitainagar, Mukundapur, Kolkata - 700099

Subject: Franchise Agreement

Dear Zingo Buy India Private Limited,

I am writing to express my interest in entering into a franchise agreement with ZINGO BUY INDIA PRIVATE LIMITED for the operation of a ZINGOFIN.COM franchise. As per our discussions and negotiations, I believe this agreement will provide a mutually beneficial opportunity for both parties.

I have thoroughly reviewed the franchise disclosure document and other relevant materials provided by ZINGO BUY INDIA PRIVATE LIMITED, and I am confident in the potential success of the ZINGOFIN.COM franchise in my desired location.

To proceed with the franchise, I would like to propose the following terms and conditions for the franchise agreement:

1. Territory:
- The designated territory for the franchise will be PAN INDIA.
- This territory will be exclusive, ensuring that no other franchises of ZINGOFIN.COM will operate within the designated area.
...
4. Training and Support:
- ZINGO BUY INDIA PRIVATE LIMITED agrees to provide comprehensive training and support to ensure the successful operation of the franchise.
- This training will cover all aspects of ZINGO BUY INDIA PRIVATE LIMITED business operations, including product knowledge, marketing strategies, and operational procedures.
- The initial training will take place at a location designated by ZINGO BUY INDIA PRIVATE LIMITED for a duration of 1 hours.
- Ongoing support will be available through regular communication channels, training materials, and assistance in resolving operational challenges.

5. Branding and Marketing:
- I agree to use the approved branding and marketing materials provided by ZINGO BUY INDIA PRIVATE LIMITED in the operation of the franchise.

6. Obligations and Responsibilities:
- I will diligently operate the franchise in accordance with the standards, procedures, and guidelines set forth by ZINGO BUY INDIA PRIVATE LIMITED.
- I will maintain proper staffing, adhere to quality control measures, and provide excellent customer service.
- I will promptly report and address any operational issues or concerns that may arise.
- I will maintain accurate records of sales, expenses, and other financial data as required by ZINGO BUY INDIA PRIVATE LIMITED.

7. Termination:
- Either party may terminate this agreement upon providing 25 Year written notice to the other party.
- Termination may occur in the event of a material breach of the franchise agreement, failure to meet performance standards, or other specified circumstances as outlined in the agreement.
- The specific circumstances under which an amount may be deemed non-refundable can vary depending on the terms and conditions set by the company. It is important for customers to carefully read and understand the terms and conditions or any agreements they enter into with a company to be aware of any non-refundable amounts.
...
- It is crucial for both companies and customers to have clear communication and understanding regarding non-refundable amounts to avoid any misunderstandings or disputes.

8. Services:
The Service Provider agrees to provide the following services to the Client by zingofin.com:
Pan Card, GST Registration, Ration Card, Government to Citizens Service, Voter Id, Flight & Hotel Booking, Money Transfer, Aadhar Update (we refuse the service of linking number in Aadhaar), Aadhar Enable Payment System (AEPS), Insurance, Banking Related Services, and 250+ more Services......

9. Governing Law and Dispute Resolution:
This Agreement shall be governed by and construed in accordance with the laws of India. Any disputes arising out of or relating to this Agreement shall be resolved through good-faith negotiations between the Parties. If the Parties are unable to reach a resolution, the dispute shall be referred to mediation or arbitration in accordance with the laws of India.
...
Thank you for considering my application. I look forward to the opportunity to become a valued franchisee of Zingo Buy India Private Limited. Should you require any additional information or documentation, please do not hesitate to contact me.

12. Terms and Conditions:
These Terms and Conditions govern your use of our website and services. By accessing or using our services, you agree to be bound by these terms.

Acceptance of Terms
By accessing and using Zingofin.com website and services, you acknowledge that you have read, understood, and agree to be bound by these Terms and Conditions. If you do not agree to these terms, please do not use our services.

Services Description
Zingofin.com provides various services including but not limited to:
- Aadhar card services (correction, update, etc.)
- PAN card services
- Bill payments and utility services
- Government document processing
...
Intellectual Property
All content, logos, trademarks, and other intellectual property on our website are owned by Zingofin.com and are protected by applicable copyright and trademark laws. You may not use our intellectual property without our express written permission.

Limitation of Liability
Zingofin.com shall not be liable for any indirect, incidental, special, consequential, or punitive damages resulting from your use or inability to use our services. Our liability is limited to the amount paid for the specific service in question.

Service Modifications
We reserve the right to modify, suspend, or discontinue any aspect of our services at any time without prior notice. We shall not be liable to you or any third party for any modification, suspension, or discontinuance of services.

Governing Law
These Terms and Conditions shall be governed by and construed in accordance with the laws of India. Any disputes arising from these terms shall be subject to the exclusive jurisdiction of the courts in Kolkata, West Bengal.
...
Information We Collect
1.1 Personal Information You Provide — Contact data: name, email address, postal address, phone number; Account information: user ID, login credentials; Service details: information you submit when availing services; Payment details: transaction IDs, billing information.

1.2 Information Collected Automatically — Usage data, device & browser data, cookies & tracking technologies.

1.3 Third-Party Sources — Analytics providers, advertising partners, payment gateways.

How We Use Your Information
We use collected data to provide & improve services, communicate with you, analyze & optimize the platform, and comply with legal & safety requirements.

Cookies & Tracking Technologies
We use cookies and similar technologies to personalize your experience and analyze traffic. You can manage or disable cookies in your browser settings; however, some features may not function properly if cookies are blocked.

Disclosure of Your Information
We may share your data with service providers, affiliates, legal authorities when required by law, and in connection with business transfers.

Data Security & Retention
We implement reasonable technical and organizational measures to protect your data. Your personal information is retained only as long as necessary to fulfill the purposes described herein.

Your Rights
Depending on applicable law, you may have the right to access, correct, delete, object to, restrict, or port your data, and withdraw consent where processing is based on consent. To exercise any of these rights, please contact us at support@zingofin.com.

Children's Privacy
Our Service is not directed to children under 18. We do not knowingly collect personal data from minors.
...
Scope — Services Covered: Aadhaar correction, PAN card application, BBPS (bill payment) services, AEPS (banking transactions), GST registration, and other government-related services.

Non-Refundable Items: Government fees, statutory charges, and third-party processing fees once paid; partially completed services where updates have already been submitted to authorities; wallet balance is non-refundable; once payment is made for services, the amount paid is non-refundable (except as specified below).

License Fee & Wallet Refund Policy:
- License Fee: License fee is refundable subject to our refund policy terms and conditions.
- Wallet Balance: Wallet balance is non-refundable. Once money is added to your wallet, it cannot be refunded. Wallet balance can only be used for availing services on our platform.

Eligibility for Refund — You may request a refund if: (1) Service Not Rendered; (2) Duplicate Purchase; (3) Erroneous Charge. Contact us within 15 days of your transaction date.

Refund Process:
1. Submit Request — Email support@zingofin.com with service name, transaction ID, date of purchase, and reason for refund.
2. Verification — We will acknowledge receipt within 30 business days and may request additional information.
3. Approval & Processing — Once approved, refunds are processed to your original payment method. The refund credit process may take up to 120 days from approval.
4. Refund Timeline — Acknowledgment within 30 business days; verification & approval 30-60 business days; credit up to 120 days from approval.

Partial Refunds, Cancellations, and Chargebacks apply as described in the full policy terms above.

15. Cancellation Policy:
This Cancellation Policy applies to all services offered through our platform (zingofin.com).

Cancellation by You — Before processing begins: free of charge via email at support@zingofin.com. After processing has started: a 10% cancellation fee applies; government or third-party fees remain non-refundable.

Cancellation by Us — We may cancel for incomplete documentation, identity verification failure, fraud, or technical/regulatory suspension.

Non-Refundable & Non-Cancellable Items — Government fees and completed service payments are non-refundable.

Client Name: {{NAME}}
Date: {{DATE}}

Yours sincerely,
Zingobuy India Private Limited
""".strip()


def is_wl_agreement_user(user):
    """WL tenant retailers/distributors/MD use the Zingofin agreement, not platform GSK."""
    ...
    return getattr(user, "role", None) in AGREEMENT_REQUIRED_ROLES


def get_agreement_version(user=None):
    if is_wl_agreement_user(user):
        return WL_AGREEMENT_VERSION
...
def get_terms_plain_text(user=None):
    if is_wl_agreement_user(user):
        return _built_in_wl_default_terms()
